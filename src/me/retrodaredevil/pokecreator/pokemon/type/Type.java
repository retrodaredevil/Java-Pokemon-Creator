...
public enum Type {
	...
	ROCK("Rock", Arrays.asList("FIGHTING", "GROUND", "STEEL"), Arrays.asList("FIRE", "FLYING")),
	...
	@Deprecated
	public boolean isSuperEffective(TypeSet set){
		return this.isSuperEffective(set.getTypes());
	}
	...
	@Deprecated
	public boolean isNotEffective(TypeSet set){
		return this.isNotEffective(set.getTypes());
	}
	...
	@Deprecated
	public boolean doesNoDamage(TypeSet set){
		return this.doesNoDamage(set.getTypes());
	}
